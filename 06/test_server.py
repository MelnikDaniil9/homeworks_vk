...
class TestServer(unittest.TestCase):
    def setUp(self):
        self.server_process = subprocess.Popen(["python3", "server.py", "-w", "10", "-k", "5"])
        time.sleep(1)
    ...
    def test_correct_url(self):
        ...
        expected_result = {url: "[('the', 454), ('Python', 337), ('and', 260), ('from', 247), ('on', 228)]"}
        server_address = ('localhost', 1489)
        s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    ...
    def test_multiple_urls(self):
        ...
        urls = ["https://en.wikipedia.org/wiki/Namikawa_S%C5%8Dsuke",
        ...
        expected_results = [
            ...
            {urls[1]: "[('the', 454), ('Python', 337), ('and', 260), ('from', 247), ('on', 228)]"},
            {urls[2]: "[('the', 326), ('to', 202), ('of', 186), ('a', 164), ('on', 163)]"},
            {urls[3]: "[('the', 627), ('and', 476), ('of', 475), ('to', 297), ('^', 256)]"},
            {urls[4]: "[('of', 170), ('the', 167), ('and', 122), ('to', 89), ('in', 80)]"}
        ]
